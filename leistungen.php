...
<head>
  ...
  <link rel="icon" href="LogoHausensteiner2.png">
  <link rel="stylesheet" href="./css/style.css">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;500;600;700&family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=The+Nautigal:wght@400;700&display=swap" rel="stylesheet">
      ...
      <div class="flip-card">
        <div class="flip-card-inner">
          ...
          <div class="flip-card-front">
            <div class="frontImg">
              <div class="frontImg_overlay">
                <h1>Wirtschaft<br>Arbeitswelt</h1>
              </div>
            </div>
      ...
      <div class="flip-card">
        <div class="flip-card-inner">
          ...
          <div class="flip-card-front">
            <div class="frontImg">
              <div class="frontImg_overlay">
                <h1>Schul- und Bildungs&shy;mediation</h1>
              </div>
            </div>
